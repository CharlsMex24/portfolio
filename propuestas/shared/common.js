/* Behaviour shared by both proposals: smooth scroll, reveals, counters, the quote verifier,
   the certificate viewer and copy-email. Each page keeps its own look and its own 3D stage. */

export const $ = (s, root = document) => root.querySelector(s);
export const $$ = (s, root = document) => [...root.querySelectorAll(s)];

export function initCommon({ reduce }) {
